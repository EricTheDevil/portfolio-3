...
/**
 * script for the Attractor pattern for the movement of the meshlines behind the orb
 */
...
export function threeScrollAttractor([x, y, z], timestep) {
    const a = 40.0;
    const b = 0.833;
    const c = 20.0;
    const d = 0.5;
...
export function thomasAttractor([x, y, z], timestep) {
    const a = 40.0;
    const b = 0.833;
    const c = 20.0;
    const d = 0.5;
